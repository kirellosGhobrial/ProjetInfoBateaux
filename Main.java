...
public class Main{
	...
	ImageIcon musiqueOn = new ImageIcon(new ImageIcon("/Users/aminemr/Pictures/musiqueON.png").getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT));
	ImageIcon mute = new ImageIcon(new ImageIcon("/Users/aminemr/Desktop/Bataille Navale/mute.png").getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT));
